...
//        testRMFunctionality();
    ...
    public static void getRequestFromFE(){
        ...
        try {
            while(true){
                System.out.println("Thread started from RM3 to detect crash");
                rmLogger.logger.info("Thread started from RM3 to detect crash");
                ds = new DatagramSocket(Constants.RM3Port);
                rmLogger.logger.info("Datagram socket opened on port: " + Constants.RM3Port);
    ...
    public static String processRequest(String reqMsg) throws MalformedURLException {
        ...
        return seqCounter + "-RM3-" + replicaResponse;
    }
